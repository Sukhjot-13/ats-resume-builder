...
export async function GET() {
  ...
  try {
    ...
    logger.error({ file: 'src/app/api/profile/route.js', function: 'GET', error: error.message }, 'Error reading data file');
...
export async function POST(request) {
  ...
  try {
    ...
    logger.error({ file: 'src/app/api/profile/route.js', function: 'POST', error: error.message }, 'Error writing data file');
