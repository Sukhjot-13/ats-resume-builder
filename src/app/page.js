...
export default function Home() {
  return (
    <div className="flex min-h-[calc(100vh-3.5rem)] flex-col bg-bg-primary text-text-primary">
      {/* Hero Section */}
      <section className="relative w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-surface">
        <div className="max-w-7xl mx-auto px-4 md:px-6 text-center">
          <div className="space-y-6">
            ...
            <p className="mx-auto max-w-[700px] text-lg md:text-xl text-text-muted">
            ...
            <div className="space-x-4">
              <Link href="/dashboard">
                <Button className="bg-accent text-brand-primary hover:bg-accent/90">
                  Get Started
                </Button>
              </Link>
              <Link href="/profile">
                <Button variant="outline" className="border-accent text-accent hover:bg-accent hover:text-brand-primary">
                  Learn More
                </Button>
              </Link>
            </div>
      ...
      {/* Features Section */}
      <section className="w-full py-12 md:py-24 lg:py-32 bg-bg-primary">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-accent">
          ...
          <div className="mx-auto grid max-w-5xl items-start gap-8 sm:grid-cols-2 md:grid-cols-3 lg:gap-10 py-12">
            <Card className="flex flex-col items-center text-center p-6 bg-surface">
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-surface">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="mx-auto grid max-w-5xl items-start gap-8 sm:grid-cols-1 md:grid-cols-3 lg:gap-10 py-12">
            <Card className="flex flex-col items-center text-center p-6 bg-bg-primary">
              <CardHeader className="flex flex-col items-center justify-center">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-accent text-brand-primary text-xl font-bold mb-4">
                  1
                </div>
      ...
      {/* Call to Action */}
      <section className="w-full py-12 md:py-24 lg:py-32 bg-brand-primary text-text-primary text-center">
      ...
      {/* Footer */}
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t bg-bg-primary">
        <p className="text-xs text-text-muted">
          &copy; 2024 ATS-Friendly Resume Builder. All rights reserved.
        </p>
        <nav className="sm:ml-auto flex gap-4 sm:gap-6">
          <Link href="#" className="text-xs hover:underline underline-offset-4 text-text-muted">
            Terms of Service
          </Link>
          <Link href="#" className="text-xs hover:underline underline-offset-4 text-text-muted">
            Privacy
