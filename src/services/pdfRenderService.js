...
export async function renderPdf(resumeData, template, returnHtml = false) {
  logger.info({ file: 'src/services/pdfRenderService.js', function: 'renderPdf' }, 'renderPdf function triggered');
  logger.debug({ file: 'src/services/pdfRenderService.js', function: 'renderPdf', template, returnHtml }, 'PDF rendering request received');
  try {
    ...
    logger.debug({ file: 'src/services/pdfRenderService.js', function: 'renderPdf', template }, 'HTML template read');
    ...
    logger.debug({ file: 'src/services/pdfRenderService.js', function: 'renderPdf', template }, 'Placeholders replaced in HTML');

    if (returnHtml) {
      logger.info({ file: 'src/services/pdfRenderService.js', function: 'renderPdf', template }, 'Returning HTML string');
      return html;
    }
    ...
    await browser.close();
    logger.info({ file: 'src/services/pdfRenderService.js', function: 'renderPdf', template }, 'PDF generated successfully');
